        ...
        <div class="flex items-center gap-4 text-white">
            ...
            <div class="relative">
                ...
                <div x-show="langMenuOpen" @click.away="langMenuOpen = false"
                     ...
                     x-transition>
                    <a href="{{ route('lang.switch', 'ar') }}" class="block px-4 py-2 hover:bg-[#F0F2F5]">العربية</a>
                    <a href="{{ route('lang.switch', 'en') }}" class="block px-4 py-2 hover:bg-[#F0F2F5]">English</a>
                </div>
            </div>
