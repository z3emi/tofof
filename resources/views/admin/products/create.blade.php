        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    {{-- صور المنتج --}}
                    <div class="mb-3">
                        <label for="images" class="form-label">صور المنتج <span class="text-danger">*</span> <small class="text-muted">(يمكن اختيار أكثر من صورة)</small></label>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price') }}" required step="any">
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('sale_price') is-invalid @enderror" id="sale_price" name="sale_price" value="{{ old('sale_price') }}" step="any">
                        @error('sale_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('sale_starts_at') is-invalid @enderror" id="sale_starts_at" name="sale_starts_at" value="{{ old('sale_starts_at') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('sale_ends_at') is-invalid @enderror" id="sale_ends_at" name="sale_ends_at" value="{{ old('sale_ends_at') }}">
                        @error('sale_ends_at')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    {{-- الفئة الرئيسية الثانية (Primary Category) - اختيار واحد فقط مثل القسم --}}
{{-- ===== NEW: اختيار الفئة الثانية (جذور + فروع تعتمد على الجذر) ===== --}}
@php
...
{{-- القيمة النهائية اللي يقرأها السيرفر مثل قبل --}}
