            ...
            <table class="table mb-0 align-middle text-center" id="orders_table">
                <thead class="bg-light border-bottom">
                    <tr class="text-muted small fw-bold">
                        ...
                        <th class="py-3 text-start" data-column-id="customer">{!! \App\Support\Sort::link('user_name', 'العميل') !!}</th>
                ...
                <tbody>
                    @forelse($orders as $order)
                        <tr>
                            ...
                            <td class="text-start">
                                <div class="fw-bold text-dark">{{ $order->customer->name ?? 'عميل محذوف' }}</div>
                    ...
                    @empty
                        <tr><td colspan="8" class="py-5 text-muted">لم يتم العثور على أي طلبات.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
