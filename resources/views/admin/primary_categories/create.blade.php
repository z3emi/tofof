...
<div class="form-card">
    <div class="form-card-header d-flex justify-content-between align-items-center">
        <div>
            <h2 class="mb-2 fw-bold text-white"><i class="bi bi-plus-circle-fill me-2"></i> إضافة فئة جديدة</h2>
            <p class="mb-0 opacity-75 fs-6 text-white small">قم بتعريف فئة جديدة لتنظيم المنتجات بشكل أفضل في المتجر.</p>
        </div>
        ...
        <div class="form-section">
            <form action="{{ route('admin.primary-categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4 pt-3 border-top d-flex gap-2">
                    <button type="submit" class="submit-btn"><i class="bi bi-check-circle me-1"></i> حفظ البيانات</button>
