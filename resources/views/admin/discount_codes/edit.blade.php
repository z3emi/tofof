            ...
            <div class="mb-5">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" class="form-control" style="border-radius:12px; padding:0.8rem" id="value" name="value" value="{{ old('value', $discount_code->value) }}" required>
                    </div>
                    <div class="col-md-6" id="max_discount_amount_wrapper" style="display:none;">
                        ...
                        <input type="number" step="0.01" class="form-control" style="border-radius:12px; padding:0.8rem" id="max_discount_amount" name="max_discount_amount" value="{{ old('max_discount_amount', $discount_code->max_discount_amount) }}">
                    </div>
                </div>
            </div>
