...
@section('title', 'إضافة مادة خام')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">إضافة مادة خام جديدة</h4>
...
<div class="card shadow-sm">
    <div class="card-body">
        <form action="{{ route('admin.manufacturing.materials.store') }}" method="POST">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="unit" class="form-control" value="{{ old('unit') }}" placeholder="كغم، لتر ...">
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" min="0" name="cost_per_unit" class="form-control" value="{{ old('cost_per_unit') }}" required>
                    </div>
                </div>
                <div class="col-12">
                    <label class="form-label">ملاحظات</label>
                    <textarea name="notes" rows="3" class="form-control" placeholder="أية تفاصيل إضافية عن المادة">{{ old('notes') }}</textarea>
                </div>
            </div>
