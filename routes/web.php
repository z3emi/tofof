...
Route::middleware(['auth:admin', 'can:view-admin-panel', 'log.admin.activity'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/products/{product}/reviews/{review}/reply', [ReviewAdminController::class, 'reply'])
        ->name('products.reviews.reply')->middleware('can:manage-reviews');
    Route::delete('/products/{product}/reviews/{review}/reply', [ReviewAdminController::class, 'destroyReply'])
        ->name('products.reviews.reply.destroy')->middleware('can:manage-reviews');
});
